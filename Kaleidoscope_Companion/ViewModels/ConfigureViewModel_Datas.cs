...
using static kaleidoscope_companion.ViewModels.ConfigureViewModel;
...
namespace kaleidoscope_companion.ViewModels
{
    static class ConfigureViewModelExtensions
    {
        ...
        /// <summary>
        /// Convert an <see cref="ConfigureViewModel.EditableAppLayerMapping" /> to an <see cref="ConfigureViewModel.AppLayerMappingItem"/>
        /// completing informations with <see cref="ApplicationMetaInf"/>
        /// </summary>
        public static ConfigureViewModel.AppLayerMappingItem ToUIModel(this ConfigureViewModel.EditableAppLayerMapping inEdition,
        ...
        /// <summary>
        /// Creates a <see cref="ConfigureViewModel.AppLayerMappingItem"/> from an <see cref="ApplicationMetaInf"/> and a layer number
        /// </summary>
        /// <param name="meta"></param>
        /// <param name="layerN"></param>
        /// <returns></returns>
        public static ConfigureViewModel.AppLayerMappingItem ToUiModel(this ApplicationMetaInf meta, int layerN)
        {
            return new ConfigureViewModel.AppLayerMappingItem(meta?.Icon, meta?.Name, meta?.ImageName, layerN);
        }

        /// <summary>
        /// Creates a <see cref="ConfigureViewModel.AppLayerMappingItem"/> from <see cref="ApplicationLayerMapping" />
        /// using <see cref="ApplicationMetaInf"/>s to complete informations
        /// </summary>
        public static ConfigureViewModel.AppLayerMappingItem ToUIModel(this ApplicationLayerMapping mapping,
            ApplicationMetaInf appMetaInf)
        {
            if (mapping == null)
                return null;

            return new ConfigureViewModel.AppLayerMappingItem(appMetaInf?.Icon, 
        ...
        /// <summary>
        /// Convert a <see cref="ConfigureViewModel.AppLayerMappingItem"/> to a <see cref="ApplicationLayerMapping"/>
        /// using <see cref="ApplicationMetaInf"/> to complete additionnal informations
        /// </summary>
        public static ApplicationLayerMapping ToModel(this ConfigureViewModel.AppLayerMappingItem item, ApplicationMetaInf metaInf)
        {
